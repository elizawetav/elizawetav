...
|[Анализ эффективности рекламных офферов в Яндекс.Директ для жилого комплекса бизнес-класса](https://github.com/elizawetav/best_practices)|Группировка рекламных офферов, расчет маркетинговых метрик (CTR, CPL, CPQ, CR) и автоматизация сегментации смысловых категорий заголовков|pandas, numpy, re, seaborn|
|     3 |                   |                   |
